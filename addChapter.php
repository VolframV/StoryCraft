...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="addChapter.php">Create<span class="sr-only">(current)</span></a>
            </li>
        </ul>
    </div>
</nav>
...
<div class="container">
    <br>
    <h1 class="text-center">ADD STORY</h1>
    ...
    <form action="" method="post">
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" name="story_name" value="" id="storyName" size="25" maxlength="60" placeholder="Story Name">
            </div>
        </div>

        <div class="row">
            <div class="form-group col-md-6">
                <label for="storyAuthor">Story Author</label>
                <input type="text" class="form-control" name="story_author" value="" id="storyAuthor" size="25" maxlength="60" placeholder="Story Author">
            </div>



            <div class="form-group col-md-6">
                <label for="inputState">Story Genre</label>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="story_description" rows="15" id="comment" placeholder="Enter Story Description...max 200 characters" maxlength="230"></textarea>
        </div>
